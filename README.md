...
- **Q: Why XQuery for healthcare data?** HL7/FHIR standards are deeply nested, hierarchical documents. Relational databases require complex normalisation across dozens of tables. XQuery operates directly on the native hierarchical tree using XPath navigation, executing queries with high performance.
